...
//Build with: gcc -o mm3d_savetool mm3d_savetool.c
...
unsigned char savegame[0x13618];
...
int main(int argc, char **argv)
{
	...
	printf("mm3d_savetool by yellows8\n");
	...
	if(filestat.st_size!=sizeof(savegame))
	{
	...
	calc_crc = crc16(savegame, filestat.st_size, 0x1017);
